...
def pretrain_model(episodes_data, model, agent, num_epochs=10, batch_size=32, gamma=0.99):
    """
    ...
    for epoch in range(num_epochs):
        ...
        for i in range(0, len(episodes_data), batch_size):
            ...
            print("Probs shape",discrete_probs.shape, continuous_probs.shape)
...
# Example usage:
state_size = 10  # Adjust based on your state size
action_size = 18  # Adjust based on your action size
...
pretrain_model(episodes_data, model, agent)
