...
class ActorNetwork(nn.Module):
    ...
    def _get_conv_output(self):
        ...
        dummy_output = torch.relu(self.conv5(torch.relu(self.conv4(torch.relu(self.conv3(torch.relu(self.conv2(dummy_input))))))))
    ...
    def forward(self, state, image):
        ...
        discrete_actions = torch.tanh(self.discrete_head(x))
...
class ActorCriticModel:
    def __init__(self, state_size, action_size, batch_size = 32, device="cpu", image_width = 480, image_height = 270):
        ...
        self.epsilon = 0.4  # For exploration
    ...
    def action(self, pos_state, image):
        ...
        #print("Actor decision: Discrete actions", discrete_actions)
        return discrete_actions, continuous_actions
    ...
    def build_output_vector(self, discrete_actions, continuous_actions):
        ...
        #print("Discrete actions 0", discrete_actions)
        discrete_actions = (discrete_actions == discrete_actions.max()).float()
        #print("Discrete actions 1", discrete_actions)
